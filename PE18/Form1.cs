...
namespace EditPerson
{
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            this.froshRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__CheckChanged);
            this.sophRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__CheckChanged);
            this.juniorRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__CheckChanged);
            this.seniorRadioButton.CheckedChanged += new EventHandler(this.ClassRadioButton__CheckChanged);
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            foreach (RadioButton rBtn in genderGroupBox.Controls.OfType<RadioButton>())
            {
                if (rBtn.Checked && rBtn.Text == "Him")
                    person.eGender = genderPronoun.him;
                else if (rBtn.Checked && rBtn.Text == "Her")
                    person.eGender = genderPronoun.her;
                else if(rBtn.Checked && rBtn.Text == "Them")
            ...
            if (person.GetType() == typeof(Student))
            {
                ...
                foreach (RadioButton rBtn in classGroupBox.Controls.OfType<RadioButton>())
                {
                    if (rBtn.Checked && rBtn.Text == "Freshman")
                        student.eCollegeYear = collegeYear.freshman;
                    else if (rBtn.Checked && rBtn.Text == "Sophomore")
                        student.eCollegeYear = collegeYear.sophomore;
                    else if (rBtn.Checked && rBtn.Text == "Junior")
                        student.eCollegeYear = collegeYear.junior;
                    else if (rBtn.Checked && rBtn.Text == "Senior")
        ...
        private void ClassRadioButton__CheckChanged(object sender, EventArgs e)
        {
