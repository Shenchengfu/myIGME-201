    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            sentence = "The quick brown fox jummped over the dog".Split(' ');
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            LinkedListNode<object>  linkedListNodeMid = linkedList.Find("on the");
            LinkedListNode<object> linkedListNodeFalls = linkedList.Find("falls");

            linkedList.Remove(linkedListNode1);
            linkedList.Remove(linkedListNodeMid);
            linkedList.Remove(linkedListNode2);

            linkedList.AddAfter(linkedListNodeFalls, linkedListNode1.Value);
            linkedList.AddAfter(linkedListNode1, linkedListNodeMid.Value);
            linkedList.AddAfter(linkedListNodeMid, linkedListNode2.Value);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            anagram.AddAfter(anagram.First, linkedListNode1.Value);
            ...
            anagram.Remove(linkedListNode1);
            anagram.AddAfter(anagram.Find("T"), linkedListNode1.Value);

            linkedListNode2 = anagram.FindLast("R");
            anagram.Remove(linkedListNode2);
            anagram.AddAfter(anagram.Find("Y"), linkedListNode2.Value);

            linkedListNode1 = anagram.Find('O');
            anagram.AddAfter(anagram.FindLast("R"), linkedListNode1.Value);
            anagram.AddAfter(anagram.Find('O'), linkedListNode1.Value);

            linkedListNode2 = anagram.Find("M");
            anagram.AddAfter(anagram.FindLast("O"), linkedListNode2.Value);
