    ...
    public partial class BTreeForm : Form
    {
        ...
        private void Exercise4__Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 15; ++i)
            {
                ...
                node = new BTree(current, root, false);
        ...
        private void Exercise6__Click(object sender, EventArgs e)
        {
            ...
            Person person = new Person("Shencheng Fu", 20);
            node = new BTree(person, node);

            // Your code here
            node = new BTree(new Person("Shencheng Fu", 25), root);
            node = new BTree(new Person("Joe", 27), root);
            node = new BTree(new Person("Maria", 31), root);
            node = new BTree(new Person("Angela", 17), root);
            node = new BTree(new Person("Noah", 28), root);
            node = new BTree(new Person("Christopher", 40), root);
            node = new BTree(new Person("Brian", 68), root);
            node = new BTree(new Person("Wendy", 74), root);
            node = new BTree(new Person("Peter", 80), root);
            node = new BTree(new Person("Houston", 55), root);
            node = new BTree(new Person("Sophia", 49), root);
            node = new BTree(new Person("Christina", 37), root);
            node = new BTree(new Person("Ariana", 65), root);
            node = new BTree(new Person("Michael", 43), root);
            node = new BTree(new Person("Robert", 59), root);
            node = new BTree(new Person("Xingjian", 86), root);
        ...
        private void Exercise7__Click(object sender, EventArgs e)
        {
            ...
            // the Person class is defined below
            Person person = new Person("Shencheng Fu", 20);
            node = new BTree(person, node, false);

            // Your code here
            node = new BTree(new Person("Shencheng Fu", 25), root, false);
            node = new BTree(new Person("Joe", 27), root, false);
            node = new BTree(new Person("Maria", 31), root, false);
            node = new BTree(new Person("Angela", 17), root, false);
            node = new BTree(new Person("Noah", 28), root, false);
            node = new BTree(new Person("Christopher", 40), root, false);
            node = new BTree(new Person("Brian", 68), root, false);
            node = new BTree(new Person("Wendy", 74), root, false);
            node = new BTree(new Person("Peter", 80), root, false);
            node = new BTree(new Person("Houston", 55), root, false);
            node = new BTree(new Person("Sophia", 49), root, false);
            node = new BTree(new Person("Christina", 37), root, false);
            node = new BTree(new Person("Ariana", 65), root, false);
            node = new BTree(new Person("Michael", 43), root, false);
            node = new BTree(new Person("Robert", 59), root, false);
            node = new BTree(new Person("Xingjian", 86), root, false);
